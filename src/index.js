...
function makeImage(imgURL) {
  ...
  image.style.height = "10em"; // height adjustment with in js. (universal)
  image.classList.add("dong"); //Each emage gets a class name of dog. (universal)
  return image; 
}// turning an image into an object. 
...
//console.log(panelkData); // log the panelData
...
// const content = panelObj.content; 
  ...
  */
  ...
  panelButtons.addEventListener("click", (evt) => {
    /* 1.hide the open button => 2nd click show open button.
       2.show the close button => 2nd click the close button.
